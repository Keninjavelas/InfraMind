...
from app.schemas.infra_schema import InfraSummary, ComplexityMetrics, Resource, Dependency, SecurityRisk
...
from app.parsers.terraform.dependencies import DependencyResolver as TFDependencyResolver
...
class ContextBuilder:
    ...
    def build_context(self) -> InfraSummary:
        ...
        public_exposure_count = len([r for r in all_risks if r.category in ["networking", "permissions"] and r.severity == "CRITICAL"])
        ...
        elif "ECS" in all_services or "K8S_DEPLOYMENT" in all_services or "COMPOSE_SERVICE" in all_services:
